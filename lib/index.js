...
const { cmd, commands,Module_Exports,Function,smd } = require(__dirname + '/plugins')
...
const bgmPlugin = require('./plugins/bgm_local.js');

// Message Handler
bot.on('message', async (msg) => {
    if (msg.body.startsWith('!bgm')) {
        await bgmPlugin.execute(msg, { conn: bot });
    }
});
